...
# 数据预处理
# -------------
def data_process(adj_path, feature_path, com_feature_path,model_name,mask,seed):
    ...
    if model_name == 'alignn':
        ...
        train_data_loader, valid_data_loader, test_data_loader = get_train_val_test_data(a, labels, co_fn='collate1', seed=seed)
        ...
        train_data_loader, valid_data_loader, test_data_loader = get_train_val_test_data(a, labels, co_fn='collate2', seed=seed)
