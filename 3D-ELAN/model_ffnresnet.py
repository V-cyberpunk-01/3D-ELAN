...
class CSGraphormer(nn.Module):
    def __init__(self, hidden_size,
        ...
        self.encoder1 = GCN(nfeat = 50,nhid = 512,node_num = 10, nclass = 256, nout=hidden_size) # all = 23
        self.encoder2 = GCN(nfeat = 50,nhid = 512,node_num = 10, nclass = 256, nout=hidden_size)
