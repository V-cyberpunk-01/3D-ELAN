...
if __name__ == '__main__':
    ...
    # path definition
    parser.add_argument('--data_path', type=str, default='./0916/NbSi_a_c0_f85_k15/all_connect',
                        help='directory to the (a)Nbsi data.')
    parser.add_argument('--com_feature_path_ego', type=str, default='./0916/composition/composition_feature_a_pca.csv',
                        help='the component feature of ego graph')
    parser.add_argument('--com_feature_path_background', default='./0916/composition/composition_feature_a_pca.csv',
